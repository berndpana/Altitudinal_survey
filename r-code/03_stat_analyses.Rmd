...
WLqpcr<-data.frame(subset(WLqpcr,select=c("ho_id","sex","elevation","length","weight","type_a","type_b","rel_quant","rel_quant_sd","phytoplasma_type","phytoplasma")))
...
Wqpcr<-data.frame(subset(Wqpcr,select=c("ho_id","sex","elevation","length","weight","type_a","type_b","rel_quant","rel_quant_sd","phytoplasma_type","phytoplasma")))
...
Lqpcr<-data.frame(subset(Lqpcr,select=c("ho_id","sex","elevation","length","weight","type_a","type_b","rel_quant","rel_quant_sd","phytoplasma_type","phytoplasma")))
```
...
regDfLRqPhy1 <- LqpcrRelQuant[LqpcrRelQuant$phytoplasma==1 & LqpcrRelQuant$rel_quant>0,]
...
```{r reg_rel_quantPhy1_sex_length, include=TRUE,echo=TRUE}
model1 <- lm(log.rel_quant~scaled.length,data=regDfPhy1)
summary(model1)
```
